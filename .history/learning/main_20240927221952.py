...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_time_per_instance", type=int, default=10000, help="The maximum time (in milliseconds) per instance.")
    parser.add_argument("--encoding_type", type=EncodingType, default=EncodingType.EXPLICIT, choices=[EncodingType.D2, EncodingType.EXPLICIT], help="The encoding type for the sketch learner.")
    parser.add_argument("--max_num_rules", type=int, default=1, help="The maximum number of rules used in the explicit encoding.")
